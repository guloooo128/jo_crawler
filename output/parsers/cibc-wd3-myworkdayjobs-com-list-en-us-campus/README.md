# cibc-wd3-myworkdayjobs-com-list-en-us-campus
...
- **页面类型**: list
- **生成时间**: 2026-02-09T15:01:31.868Z

## 文件说明

- **parser.js**: 自动生成的解析器代码
- **src/parsers/generated/cibc-wd3-myworkdayjobs-com-list-en-us-campus.js**: 用于动态加载的副本
...
```json
{
  ...
  "url": "https://cibc.wd3.myworkdayjobs.com/en-US/campus",
  "pageType": "list",
  "generatedAt": "2026-02-09T15:01:31.868Z"
}
```
