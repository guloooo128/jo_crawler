# apply-careers-microsoft-com-detail-861a1a43

## 基本信息

- **域名**: apply.careers.microsoft.com
- **URL**: https://apply.careers.microsoft.com/careers?start=0&pid=1970393556749000&sort_by=timestamp
- **页面类型**: detail
- **生成时间**: 2026-02-05T10:16:12.626Z

## 文件说明

- **parser.js**: 自动生成的解析器代码
- **src/parsers/generated/apply-careers-microsoft-com-detail-861a1a43.js**: 用于动态加载的副本
...
import Parser from './output/parsers/apply-careers-microsoft-com-detail-861a1a43/parser.js';
...
```json
{
  ...
  "url": "https://apply.careers.microsoft.com/careers?start=0&pid=1970393556749000&sort_by=timestamp",
  "pageType": "detail",
  "generatedAt": "2026-02-05T10:16:12.626Z"
}
```
